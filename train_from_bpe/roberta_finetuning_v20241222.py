...
model = RobertaForSequenceClassification.from_pretrained(PRETRAINED_MODEL_DIR_BPE_4L8HT2, num_labels=2)

# Define training arguments
NUM_EPOCHS = 100
training_args = TrainingArguments(
    output_dir=FINETUNING_MODEL_DIR_BPE_4L8HT2,
    overwrite_output_dir=True,
    per_device_train_batch_size=512, # 最开始设置为 32
    ...
    logging_dir=os.path.join(FINETUNING_MODEL_DIR_BPE_4L8HT2, 'logs'),  # Directory for storing logs
...
trainer.save_model(FINETUNING_MODEL_DIR_BPE_4L8HT2)
...
# 保存评估结果
with open(os.path.join(FINETUNING_MODEL_DIR_BPE_4L8HT2, "best_model_eval_metrics.txt"), "w") as f:
