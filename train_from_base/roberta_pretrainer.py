...
def train():
    ...
    # tokenizer_path = os.path.join(TOKEN_DIR_BASE, "tokenizer")
    ...
    training_args = TrainingArguments(
        output_dir=PRETRAINED_MODEL_DIR_BASE,
    ...
    trainer.save_model(PRETRAINED_MODEL_DIR_BASE)
    ...
    plt.legend()
    plt.savefig(os.path.join(PRETRAINED_MODEL_DIR_BASE, "loss_curve.png"), format="png", dpi=300, bbox_inches="tight")
...
def encode():
    ...
    tokenizer=RobertaTokenizer.from_pretrained(TOKEN_DIR_BASE)
    model=RobertaForMaskedLM.from_pretrained(PRETRAINED_MODEL_DIR_BASE)
    ...
    # ['C', 'C', 'C', 'T', 'A', 'A', 'A', 'C', 'C', 'C', 'T', 'A', 'A', 'A', 'C', 'C', 'C', 'T', 'A', 'A', 'C', 'C', 'C', 'T', 'A', 'A', 'C', 'C', 'C', 'T', 'A', 'A', 'C', 'C', 'C', 'T', 'A', 'A', 'C', 'C', 'C']
    # result = fill_mask("CCCTAAA<mask>CCCTAACCCTAACCCTAACCCTAACCC")
    result = fill_mask("CCCTAAA<mask><mask><mask><mask><mask><mask><mask>CCCTAA<mask><mask><mask><mask><mask><mask>CCCTAACCCTAACCC")
    # print(result)
    for i in result:
        print(i[0])
