...
#     "pseudo_positive_samples_HEK293T_v1.csv",
#     "pseudo_negative_samples_HEK293T_v1.csv",
#     add_pseudo=True
# )
...
model = DualTowerForSequenceClassification_semi(config, is_pretrained=True, pretrained_version=5)
# print(model)
...
training_args = TrainingArguments(
    output_dir=SAVED_MODEL_DIR_SEMI_V2,
    ...
    logging_dir=os.path.join(SAVED_MODEL_DIR_SEMI_V2, 'logs'),  # Directory for storing logs
...
trainer.save_model(SAVED_MODEL_DIR_SEMI_V2)
...
# 保存评估结果
with open(os.path.join(SAVED_MODEL_DIR_SEMI_V2, "best_model_eval_metrics.txt"), "w") as f:
